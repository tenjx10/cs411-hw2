...
class Meal:
    """
    Represents a meal with specific properties including its name, cuisine, price, and difficulty.
    """
    ...
    def __post_init__(self):
        """
        Validates that the price is a positive number and difficulty is one of the allowed values.

        Raises:
            ValueError: If price is non-positive or difficulty is not one of 'LOW', 'MED', or 'HIGH'.
        """
...
def create_meal(meal: str, cuisine: str, price: float, difficulty: str) -> None:
    """
    Adds a new meal to the database with the specified attributes.
    ...
    Raises:
        ValueError: If price is non-positive, difficulty is invalid, or if the meal already exists.
...
def delete_meal(meal_id: int) -> None:
    """
    Marks a meal as deleted in the database, removing it from active use.
...
def get_leaderboard(sort_by: str="wins") -> dict[str, Any]:
    ...
    Args:
        sort_by (str): The criteria to sort by, either "wins" or "win_pct".

    Returns:
        dict[str, Any]: A list of dictionaries containing meal information and win statistics.

    Raises:
        ValueError: If sort_by parameter is invalid.
        sqlite3.Error: For database errors during query execution.
    """
...
def get_meal_by_id(meal_id: int) -> Meal:
    """
    Retrieves a meal by its ID, if it exists and has not been deleted.

    Args:
        meal_id (int): The unique identifier of the meal.

    Returns:
        Meal: The Meal object for the specified ID.
...
def get_meal_by_name(meal_name: str) -> Meal:
    """
    Retrieves a meal by its name, if it exists and has not been deleted.

    Args:
        meal_name (str): The name of the meal to retrieve.

    Returns:
        Meal: The Meal object for the specified name.
...
def update_meal_stats(meal_id: int, result: str) -> None:
    ...
    Raises:
        ValueError: If the meal is deleted, not found, or if result is invalid.
        sqlite3.Error: For database-related errors.
    """
    try:
        with get_db_connection() as conn:
